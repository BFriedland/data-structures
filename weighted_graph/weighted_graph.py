...
class WeightedGraph:
    ...
    def nodes(self):
        ''' Return a list containing all Nodes in the WeightedGraph. '''
    ...
    def edges(self):
        ...
        of every Edge in the WeightedGraph contained in separate
    ...
    def add_node(self, n, _returning=False):
        ''' Add a new Node with the value n to the WeightedGraph. '''
    ...
    def del_node(self, n):
        ...
        if self.has_node(n) is False:
            ...
            raise Exception("{} not in WeightedGraph".formate(n))
    ...
    def del_edge(self, n1, n2):
        ...
        n1 and n2 from the WeightedGraph. If no such Edge
        ...
        if found_the_correct_edge is False:
            raise Exception("Edge ({}, {}) not in WeightedGraph".format(n1,
                                                                        n2))

    def neighbors(self, n):
        ''' Return the list of all Nodes connected to Node n by Edges.
        Raise an exception if n is not in the WeightedGraph. '''

        if self.has_node(n) is False:
            raise Exception("{} not in WeightedGraph.\n"
                            "WeightedGraphlist:\n"
    ...
    def adjacent(self, n1, n2):
        ...
        Nodes are not in the WeightedGraph. '''

        if not self.has_node(n1):
            raise Exception("{} not in WeightedGraph".format(n1))

        if not self.has_node(n2):
            raise Exception("{} not in WeightedGraph".format(n2))
...
if __name__ == '__main__':
    ...
    somewhat_complicated_graph = WeightedGraph()
