...
class Graph:
    ...
    def __init__(self):
        ...
        # Note: This is NOT the same as the specifications'
        # Graph.nodes() method, but it is functionally identical.
        # I simply found it most convenient to store that data
        # as state in an attribute of the exact same name.
        self.nodes = []
