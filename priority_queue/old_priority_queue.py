...
class PriorityQueue():
    ...
    def _insert(self, item):
        # The internal call -- should never raise value errors, right?
        # This is to hide the implementation from the user.
    ...
    def insert(self, item, priority):
        ...
        if isinstance(item, Node):
            ...
            item_to_insert = Node(item, priority)

        self._insert(item_to_insert)
